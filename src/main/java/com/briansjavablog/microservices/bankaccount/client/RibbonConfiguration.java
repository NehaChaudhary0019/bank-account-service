	...
	public ServerList<Server> serverList() {
		...
		return new ServerList<Server>() {
			...
			public List<Server> getUpdatedListOfServers() {
				...
				List<Server> serverList = Arrays.asList(new Server("http", "localhost", 8091), new Server("http", "localhost", 8090));
			...
			public List<Server> getInitialListOfServers() {
				...
				return Arrays.asList(new Server("http", "localhost", 8091), new Server("http", "localhost", 8090));
			}
		};
	}
